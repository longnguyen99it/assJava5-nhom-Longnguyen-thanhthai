...
@EnableJpaRepositories("codelean.repository")
@ComponentScan("codelean")
...
public class ApplicationConfig implements WebMvcConfigurer {
    ...
    public InvoiceDetailsService invoiceDetailsService(){
        return new InvoiceDetailsServiceImpl();
    }
...
//        // 1MB
//        resover.setMaxUploadSize(20971520);
//        return resover;
//    }
    ...
    //Cấu hình JPA với csdl là sql server
    //Cấu hình JPA
    //Cấu hình JPA
    @Bean
    ...
    public DataSource dataSource(){
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/assjavacualong");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        emBean.setPackagesToScan(new String[]{"codelean.model"});
